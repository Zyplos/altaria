...
if(
bb:getType()~="lineBreakFakeObject")then
bb:addProperty("FlexGrow","number",0)bb:addProperty("FlexShrink","number",0)
bb:addProperty("FlexBasis","number",0)end
...
1 -__a+1,1),bb(baa-__a+1,1)))end end end;ad.__index=ad;return setmetatable(ad,dc)end end;return aa["main"]()